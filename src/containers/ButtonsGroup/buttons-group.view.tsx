...
const Button: FC<ButtonProps> = (props) => {
  const Styled = styled.button`
    ...
    gap: 10px;
    white-space: nowrap;
    color: ${props.right ? "#505050" : props.primary ? "#FFF" : "#505050"};
    font-size: 12px;
    font-style: normal;
    font-weight: 600;
    line-height: normal;
    order: ${props?.left ? 1 : 0};
  ...
  return (
    <Group>
      ...
      <MiddleContainer>
        {x.middle.amount === 3 ? (
          <>
            <Button isArrow primary onClick={x.middle.left}>
              <svg
            ...
            <Button isArrow primary onClick={() => x.middle.right()}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 58 48"
                fill="none"
      ...
      {x.right ? (
        <Button right primary onClick={x.right}>
          Завершить
        </Button>
      ) : null}
    </Group>
