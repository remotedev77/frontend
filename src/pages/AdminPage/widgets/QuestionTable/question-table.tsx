...
import {
    ...
    MainFilterControlls,
    Row,
    SearchBar, SubFilters,
    Table
} from "../../components";
import useSWRInfinite from "swr/infinite";
import {DataFormat, QuestionTableVm} from "./question-table.vm.ts";
import {CsvModal,} from "../Modals";
import {EditQuestion} from "../Modals/Questions/EditQuestion/edit-question.modal.tsx";
...
export const QuestionTable:FC<QuestionTableProps> = observer(x =>{
    ...
    const Filters = observer(()=>{
        ...
        return<FilterSectionContainer>
            <MainFilterControlls>
                <SearchBar placeholder="Поиск" onSearchChange={()=>{}} onSearch={()=>{}} />
    ...
    const MappedInfo = observer(() =>{
        ...
        return<>
            {vm.getQuestions().map((q,i)=><Row onClick={()=>x.vm.CurrentModal = <EditQuestion vm={x.vm} question={q}/>} key={i}>
